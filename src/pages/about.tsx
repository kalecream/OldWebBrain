		...
		<Page title="About">
			<section>
				...
				<div className="paragraph">
					<p>
						Hey there, internet wanderer! I'm Sabrina aka KaleCream, but you can call me whatever floats your digital
						boat.
					</p>
					...
					<p>
						...
						below. My most frequently read book tags are: <b>{topGenres}</b>.{' '}
					</p>
					...
					<p>
						Grey is all the books I added, Dark grey is the books that I've started and Green are finished books! The
						number per month is number of finished + started books in my Library.{' '}
					</p>
					<BacklogGraph />
					<BookShelf />
				</div>
