        ...
        <div className="stat-block wide">
          ...
          <div className="section-left">
            ...
            <div className="property-block">
              ...
              <p>This item can control the local weather or climate.</p>
            </div>
            <div className="property-block">
              <h4>Lunar/Solar.</h4>
              <p>
                In the sunlight or moonlight, this gains a boost to its abilities. A lunar item might instead gain
                powers under the full moon.
              </p>
            </div>
          </div>
