...
const AboutBooksSection = () => {
  ...
  return (
    <section id="books" style={{ minHeight: "100vh" }}>
      <div className={styles.paragraph}>
        ...
        <p className="prose blur ">
          ...
          <b>{Books.filter((book) => book.status != "Want").length}</b> books in my library, and I'm always looking for
          more. I prefer {Percentage[0] > Percentage[1] ? "Fiction" : "Non-Fiction"}, and read in a{" "}
          <b>
