...
const AboutMeHero = () => {
  return (
    <div
      className="flex-row"
      style={{ alignItems: "center", justifyContent: "center", gap: "0.5rem", marginBottom: "2rem" }}
    >
      <div className="frame">
        <Image
      ...
      <div style={{ margin: "0.5rem" }}>
        <p>
          I'm currently trying to figure out how to design this page. I have some more of my media habits in{" "}
          <Link href="/books">my books section</Link>.
        </p>
      </div>
    </div>
  );
  ...
  return (
    <>
      ...
      <div className={styles.paragraph} id="podcasts">
        ...
        <div
          className="flex-row"
          style={{ flexWrap: "wrap", justifyContent: "center", gap: "1rem", margin: "1rem auto", maxWidth: "800px" }}
        >
  ...
  return (
    <div className="flex-column" style={{ minHeight: "100vh", marginTop: "8rem" }}>
      ...
      <div className={style["content-wrapper"]}>
        <div className={style["content-card"]}>{currentContent()}</div>
      </div>
    </div>
  );
};
