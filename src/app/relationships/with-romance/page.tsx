const WithRomance = () => {
  return (
    <section id="romance">
      ...
      <p className="prose">
        The sense of excitement and physical attraction to a new flame is always wonderful. It feels like I have greater
        motivation to do anything when I get a crush. My crushes tend to be superficial. I like that my fleeting crushes
        highlight small romantic things about persons that I can remember them by. I hope that I never age out of
        crushes and that I continue to be considerate of any partners when having crushes.
      </p>
      <p className="prose">
        I want it particularly noted that I don't believe in “right person, wrong time.” Life sucks. There's never going
        to be a right time, there's no guarantee that the person you knew this year is the same as they will be next
        year. Traumatic events are always happening. They force us to reconsider who we are and what we are willing to
        do. This is also why we should go slowly. A rushed relationship with no foundation will leave questions on where
      ...
      <p className="prose">
        ...
        relationship, I realized this model is much better to detail conversations off the bat would be off the table to
      ...
      <div>
        <h3>Partnership</h3>
        <p className="prose">
          Commitment is a dynamic and evolving aspect of a relationship. It requires ongoing effort, communication, and
          a shared understanding of each other's needs and expectations. The level and nature of commitment can vary
          among individuals and relationships. Not everyone may prioritize commitment in the same way. Open
          ...
          than just romantic relationships. It involves a investment of feelings, trust, and mutual support. An enduring
      ...
      <p className="prose">
        <i>
          A partner is someone who truly shares my life. We can have fun together every day even doing the most mundane
          chores. We see each other through the good days and the bad, and in doing so, we foster huge amounts of trust
          and understanding. And when you have someone who you really trust who just gets you in the bedroom? Oh man,
          it’s insane. [^5]
        </i>
      </p>
      <div className="prose">
        ...
        <ol>
          <li>
            To understand my own needs and desires. It signals an understanding of what I want out of life, independent
            of the relationship.
          </li>
