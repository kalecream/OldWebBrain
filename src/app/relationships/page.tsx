		...
		<>
			...
			<section id="introduction">
				...
				<p className="prose">
					...
					for, I realize we've all been basing our social life on vibes, pop culture and hording whatever we lacked in our
					formative years. The alternative I've seen isn't better. Some who have thought about it have just swallowed some
					philosopher’s world-view. I have no heroes, so that approach doesn't gel with me. I want to create my own
					thoughts on this with my own reasoning. I don't want to do that from scratch and it would make no sense to
					throw away the thoughts that came before me in this venture. My thoughts are speaking on all relationships
					unless I specify romantic. I believe that romantic relationships should be an evolution of friendship. One
					cannot be a good partner without being a good friend to their partner.
				</p>
				<p className="prose">
				...
				<ol className="prose">
					...
					<li>
						We all know that life likes to just throw us off the road for no reason therefore adaptability and
						consideration are absolutely key.{' '}
					</li>
