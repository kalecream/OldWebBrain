            ...
            content: [
                {
                    title: '2024 - Fall',
                    content: <div>
                        <p>The focus of this season is introspection, a backlog that I've neglected and previous goals which were not completed.<br /><br /> Recently, I've been made aware of some negative traits of mine. With cursory thoughts, I see it affects my relationship with myself. Working on this will have a positive effect on my relationship with everyone else.
                        </p>
                    </div>
                },

                {
                    ...
                    content: (
                        <>
                            <p>I'm still working on last season's goals + want to focus on repairing, low-tech and continued sustainability tasks this season.</p>
                        </>
                    )
                }
            ...
            content: [
                {
                    ...
                    content: (
                        <>
                            <p>This spring is a busy time. I am trying to re-orient myself to handle the rest of the year. The quarter
                                ...
                                stronger sense of self.</p>
                        </>
                    )
                },
                {
                    title: '2023 - Winter',
                    content: <div><p>A paradigm shift.</p><p>This is when I started this page. At the time, I was exploring individualism vs caring for myself as a member of a community. This might re-appear as a goal-point after I read Frantz Fanon's Wretched of the Earth. This is also when I had some awakenings about everyday life and lost most of my heroes.</p> <p> It ended with my giving up religion. I have oscillated between being a Christian revert & apostate for many years. The bombing of Bethlehem on Christmas Day with little out-cry from Western Church leaders was the final straw for me. It does not make sense for me to practice a religion that is so far removed from its roots / holy sites. This was not the first time I noticed that what is generally practiced is an abstract version of Christianity, but it was the occasion that disgusted me the most. The other Abrahamic religions do not appeal to me.</p></div>
                }
            ]
        }
    ];
    ...
    return (
        <>
            <div
                ...
                id="open-journal"
                onClick={handleOpen}
            ><h2 className={style["journal-title"]}>Archive</h2></div>
