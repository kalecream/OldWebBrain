  ...
  return (
    <section>
      ...
      <p className="prose blur">
        ...
        social event to meet new people and I will be enforcing the <b>relaxed</b>. The comfort of everyone in
      ...
      <h2>What to Wear</h2>
      <p className="prose blur">
        The dress code is casual, the same as you would to have lunch with friends. Clothing at an average munch will
        range from relatively casual to party clothes, and all of them are welcome. This isn't the time to wear
        fetishwear because we're in a public location.
      </p>
      <h2>Comfort</h2>
      <p className="prose blur">
