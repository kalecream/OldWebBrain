...
export const SecondHero = () => {
  ...
  return (
    <section
      style={{ backgroundColor: "var(--backgroundColor)", borderRadius: "var(--borderRadius)", minHeight: "100vh" }}
    >
        ...
        <div className={styles["button-block"]} style={{ lineHeight: "1.1" }}>
          <Link href="/rolodex">
            ...
            >
              ...
              <p className="text-center prose-small">A collection of bookmarks from other websites.</p>
            </div>
          </Link>
          ...
          <Link href="/changelog">
            ...
            >
              ...
              <p className="text-center prose-small">All website changes I make.</p>
            </div>
          </Link>
          <Link href="https://notes.sabrinamedwinter.com">
            ...
            >
              ...
              <p className="text-center prose-small">A collection of notes on different subjects.</p>
            </div>
          </Link>
        </div>
      </div>
