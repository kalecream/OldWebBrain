...
export const PastJobs: WorkType[] = [
	...
	},
	{
		...
		points: [
			'Designing static webpages from scratch.',
			'Modifying WordPress themes for retail businesses and setting up their Google Analytics dashboards.',
			'Interviewing clients to create wireframes and a brand style guide then designing responsive layouts in Figma following UI/UX best practices. ',
			'After client confirmation, creating the website using the React.js framework or HTML5, SCSS, and Javascript. ',
			' After project completion, providing documentation to the clients in the form of a knowledge management database or video tutorials.',
		],
	},
	{
