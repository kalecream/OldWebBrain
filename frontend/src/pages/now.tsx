		...
		<Page>
			<section>
				...
				<div className="prose">
					...
					<p>
						These aren't exactly goals, but a collection of things/experiences I'm trying to complete. I'll likely
						update the points with a blog post to show progress.
					</p>
					...
					<div className="prose">
						...
						<p>
							<ul className={style.spring}>
								...
								<li>Advancing in the <Link href="https://c25k.com/c25k_plan/">C25K program</Link>.</li>
