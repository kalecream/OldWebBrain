...
const Bookmarks: BookmarkProps[] = [
	...
	},
	{
		...
		title: 'Grim Grains',
		description: 'A vegan cooking blog with cute illustrations. I\'ve been thinking about blogging about exploring cooking and exploring making a fallback cookbook for myself in a similar format, but I don\'t want to be a copycat.',
		tags: ['cooking'],
		type: 'website',
	},
	{
        ...
        tags: [''],
        description: "\"A failure resume isn’t just a showcase of failure in and of itself, but also a document of all the spectacular ways you’ve worked hard towards your own goals and accomplishments. In many ways, it validates your struggle and your effort.\"",
		type: 'article',
	},
	{
