    ...
    diffPatches.forEach(diffPatch => {
      ...
      diffs.forEach((diff, index) => {
        ...
        if (diffType === DIFF_INSERT) {
          ...
          if (!diffs.slice(index).every(_ref5 => {
            let [dType] = _ref5;
...
const PortableTextEditable = React.forwardRef(function PortableTextEditable2(props, forwardedRef) {
  ...
  }), [decorate, handleCopy, handleKeyDown, handleOnBeforeInput, handleOnBlur, handleOnFocus, handlePaste, props.style, readOnly, renderElement, renderLeaf, scrollSelectionIntoViewToSlate]);
