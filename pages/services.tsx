			...
			<section>
				...
				<CardContainer>
					...
					<Card className="animate__animated animate__fadeIn animated_delay-2s">
						...
						<ServiceDescription>
						Creation of custom websites that are visually appealing, user-friendly, and optimized for search engines.
						</ServiceDescription>
					...
					<Card className="animate__animated animate__fadeIn animated_delay-2s">
						...
						<ServiceDescription> Creation of a custom and effective website that meets the needs of your business or personal project.
						</ServiceDescription>
				...
				<p>
					...
					my clients. That's why I offer flexible pricing options to ensure that
					I can meet the budget of every client.
					<br />
					<br />
					I offer a range of services at various price points, so you can choose
					the level of support that fits your budget. I am also open to
					negotiating rates for larger projects or longer-term engagements.
					<br />
					<br />
					I believe that everyone should have access to high-quality services,
